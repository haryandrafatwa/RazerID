	...
	<section>
		...
		<div class="container-xl">
			...
			<div class="row">
				...
				<div class="col-xl-4">
					<div style="text-align: center; margin-top: -360px;z-index: 10">
						<span style="color: white;z-index: 10;font-family: Titillium; font-size: 24px;">SELAMAT DATANG</span>
						<form action="<?=base_url();?>/index.php/user/login" method="post">
							...
							<div class="field" style="margin-top: 28px;float: right">
								<a href="#" style="color: #888;"><span style="font-size: 13px;">Lupa sandi?</span></a>
							</div>
