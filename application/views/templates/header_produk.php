...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark justify-content-center" style="padding: 0px;">
		<div class="container">
			<a class="navbar-brand" href="<?=base_url();?>index.php/user/account" style="padding: 0px;margin-top: -5px;margin-bottom: -5px;margin-left: -20px;margin-right: 50px">
			...
			<div class="dropdown">
				<span class="nav-link" style="cursor: pointer;" href="#" id="drp-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><!--
					<img src="" class="rounded-circle" alt="" width="36px" height="36px" style="border: 2px solid white;">-->
					<?php
						echo '<img src="data:image/jpeg;base64,'.base64_encode($user['photo']).'" class="rounded-circle" alt="" width="36px" height="36px" style="border: 2px solid white;"/>';
					?>
				</span>
